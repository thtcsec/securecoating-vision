...
<!-- TEST_MANIFEST:START -->
The current software validation snapshot is 267 passing tests with 0 skips and 0 failures (commit `1bca50c3288f`, working tree clean, source diff `none`, Python 3.11.9, 79.38s). The authoritative record is [reports/test_manifest.json](reports/test_manifest.json). This does not constitute evidence of factory performance, physical PLC behavior, safety-rated E-stop operation, or production qualification.
<!-- TEST_MANIFEST:END -->
