...
<!-- TEST_MANIFEST:START -->
The current software validation snapshot is 267 passing tests with 0 skips and 0 failures (commit `a86b003fe0bb`, working tree clean, source diff `none`, Python 3.11.9, 86.37s). The authoritative record is [reports/test_manifest.json](reports/test_manifest.json). This does not constitute evidence of factory performance, physical PLC behavior, safety-rated E-stop operation, or production qualification.
<!-- TEST_MANIFEST:END -->
