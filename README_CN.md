...
<!-- TEST_MANIFEST:START -->
当前软件验证快照为 259 项测试通过、0 项跳过、0 项失败（提交 `e7981a96bb09`，工作树有未提交变更，源码差异 `19034d9bb04e`，Python 3.11.9，耗时 76.8 秒）。权威记录为 [reports/test_manifest.json](reports/test_manifest.json)。该记录仅证明当前软件测试结果，不代表工厂性能、真实 PLC 行为、安全等级急停认证或生产资质。
<!-- TEST_MANIFEST:END -->
