...
def build() -> Path:
    ...
    # Scrub python-pptx template metadata (default author must not remain "Steve Canny").
    prs.core_properties.author = "Trinh Hoang Tu"
    prs.core_properties.last_modified_by = "Trinh Hoang Tu"
    prs.core_properties.title = title
    prs.core_properties.subject = "Track 4 final defense — Team 71 / HUFLIT"
    prs.core_properties.category = "AI + Materials Competition"
    prs.core_properties.comments = (
        "SecureCoating-Vision defense deck. Generated by scripts/generate_defense_slides.py."
    )
